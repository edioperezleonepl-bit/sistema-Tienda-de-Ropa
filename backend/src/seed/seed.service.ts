    ...
    const productsData = [
      {
        ...
        description: 'Chaqueta de cuero genuino estilo motero con detalle de franja deportiva, cremalleras metálicas y forro térmico. Diseño emblemático de alta costura.',
        sku: 'CZ-005',
        basePrice: 185.0,
        ...
        supplierId: sup1.id,
        imagesJson: JSON.stringify(['/garments/biker_jacket.jpg']),
        arOverlayImageUrl: '/garments/biker_jacket.jpg',
      ...
      {
        name: 'Polera Casual Minimalista Luxury',
        description: 'Polera de corte oversize confeccionada en algodón mercerizado de primera calidad. Caída elegante para combinación urbana.',
        sku: 'TSH-006',
        basePrice: 48.0,
        ...
        supplierId: sup1.id,
        imagesJson: JSON.stringify(['/garments/black_tshirt.jpg']),
        arOverlayImageUrl: '/garments/black_tshirt.jpg',
        arAnchorType: ARAnchorType.TORSO,
        isFeatured: true,
        variants: [
          { size: 'S', colorName: 'Negro Clásico', colorHex: '#000000', sku: 'TSH-006-S', priceAdjustment: 0 },
          { size: 'M', colorName: 'Negro Clásico', colorHex: '#000000', sku: 'TSH-006-M', priceAdjustment: 0 },
          { size: 'L', colorName: 'Negro Clásico', colorHex: '#000000', sku: 'TSH-006-L', priceAdjustment: 0 },
          { size: 'XL', colorName: 'Negro Clásico', colorHex: '#000000', sku: 'TSH-006-XL', priceAdjustment: 0 },
        ],
      },
      {
        name: 'Blazer Ejecutivo de Sastrería',
        description: 'Blazer de corte moderno con solapa clásica, forro interior satinado y botones dorados. Confección de precisión.',
        sku: 'BLZ-001',
        basePrice: 145.0,
        categoryId: catChaquetas.id,
        seasonId: s1.id,
        collectionId: col1.id,
        supplierId: sup1.id,
        imagesJson: JSON.stringify(['/garments/blazer.jpg']),
        arOverlayImageUrl: '/garments/blazer.jpg',
        arAnchorType: ARAnchorType.TORSO,
        isFeatured: true,
        variants: [
      ...
      },
      {
        ...
        description: 'Vestido largo con caída fluida, confeccionado en satén carmesí premium con detalle de escote en V y falda acampanada.',
        sku: 'VES-002',
        basePrice: 210.0,
        ...
        supplierId: sup2.id,
        imagesJson: JSON.stringify(['/garments/evening_dress.jpg']),
        arOverlayImageUrl: '/garments/evening_dress.jpg',
      ...
      },
      {
        ...
        description: 'Camisa formal de popelín de algodón 100% puro con cuello abotonado y botones nacarados.',
        sku: 'CAM-003',
        basePrice: 65.0,
        categoryId: catCamisas.id,
        seasonId: s1.id,
        collectionId: col1.id,
        supplierId: sup1.id,
        imagesJson: JSON.stringify(['/garments/white_shirt.jpg']),
        arOverlayImageUrl: '/garments/white_shirt.jpg',
        arAnchorType: ARAnchorType.TORSO,
        isFeatured: false,
        variants: [
      ...
      },
      {
        ...
        description: 'Pantalón vaquero de corte recto con tiro medio, confeccionado en denim rígido resistente con acabado lavado negro.',
        sku: 'JNS-004',
        basePrice: 95.0,
        ...
        collectionId: col3.id,
        supplierId: sup2.id,
        imagesJson: JSON.stringify(['/garments/denim_pants.jpg']),
        arOverlayImageUrl: '/garments/denim_pants.jpg',
      ...
      {
        name: 'Cinturón Reversible con Hebilla GG',
        description: 'Cinturón en piel auténtica con detalle de tribanda verde y roja y hebilla dorada. Reversible para uso formal o casual.',
        sku: 'ACC-007',
        basePrice: 120.0,
        categoryId: catChaquetas.id,
        seasonId: s1.id,
        collectionId: col1.id,
        supplierId: sup1.id,
        imagesJson: JSON.stringify(['/garments/belt.jpg']),
        arOverlayImageUrl: '/garments/belt.jpg',
        arAnchorType: ARAnchorType.TORSO,
        isFeatured: true,
        variants: [
          { size: '85', colorName: 'Negro / Verde-Rojo', colorHex: '#111827', sku: 'ACC-007-85', priceAdjustment: 0 },
          { size: '90', colorName: 'Negro / Verde-Rojo', colorHex: '#111827', sku: 'ACC-007-90', priceAdjustment: 0 },
          { size: '95', colorName: 'Negro / Verde-Rojo', colorHex: '#111827', sku: 'ACC-007-95', priceAdjustment: 0 },
        ],
      },
    ];
